...
//  替身发出音效
    ...
    public List<Float> getAttributes() {
        ...
        for(String s : attributes){
            afs.add(NumberUtils.createFloat(s));
        }
        return afs;
    }
    ...
    public StandCustomInfo decorate() {
        ...
        if (disc == null) {
            disc = new ResourceLocation(stand).getNamespace()+":"+"textures/entity/" + new ResourceLocation(stand).getPath() + ".png";
        }
        ...
        if (attributes == null || attributes.size() == 0) {
            attributes = Lists.newArrayList("1.2f","10f","200f","2f","60000","75");
        }
