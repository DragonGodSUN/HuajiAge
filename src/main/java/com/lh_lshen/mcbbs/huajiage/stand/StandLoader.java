...
//	public static final StandBase STAND_EMPTY = new StandBase("empty",0,0,0,0,0,"",HuajiConstant.StandType.STAND_EMPTY);
	public static final StandTheWorld THE_WORLD = new StandTheWorld("the_world",1.2f,10f,200,2f,60000,"textures/entity/entity_the_world.png",HuajiConstant.StandType.STAND_THE_WORLD, false);
	public static final StandStarPlatinum STAR_PLATINUM = new StandStarPlatinum("star_platinum",1.5f,15f,275,2f,50000,"textures/entity/entity_star_platinum.png",HuajiConstant.StandType.STAND_STAR_PLATINUM, false);
	public static final StandHierophantGreen HIEROPHANT_GREEN = new StandHierophantGreen("hierophant_green",1.0f,5f,200,20f,70000,"textures/entity/entity_hierophant_green.png",HuajiConstant.StandType.STAND_HIEROPANT_GREEN, false);
	public static final StandOrgaRequiem ORGA_REQUIEM = new StandOrgaRequiem("orga_requiem",0.04f,0f,650,50f,80000,"textures/entity/entity_orga_requiem.png",HuajiConstant.StandType.STAND_ORGA_REQUIEM, true);
