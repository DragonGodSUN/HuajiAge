...
//	public static final StandBase STAND_EMPTY = new StandBase("empty",0,0,0,0,0,"",HuajiConstant.StandType.STAND_EMPTY);
	...
	public static final StandHierophantGreen HIEROPHANT_GREEN = new StandHierophantGreen("hierophant_green",1.0f,5f,200,20f,70000,80,"textures/entity/entity_hierophant_green.png",HuajiConstant.StandType.STAND_HIEROPANT_GREEN, true);
	...
	public static final StandKillerQueen KILLER_QUEEN = new StandKillerQueen("killer_queen",0.6f,8f,300,100f,60000,80,"textures/entity/entity_killer_queen.png",HuajiConstant.StandType.STAND_KILLER_QUEEN, true);
