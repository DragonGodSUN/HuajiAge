...
public class RecipePolyProcessor implements IComponentProcessor {
	...
	public void setup(IVariableProvider<String> variables) {
		...
		outItem = HuajiPolyRecipeList.instance().getSmeltingResult(inItem);
	}
	...
	public String process(String key) {
		...
		else if(key.equals("ipool"))
			return Integer.toString(HuajiPolyRecipeList.instance().getPoint(inItem));
		
		else if(key.equals("iname"))
			return "$(bold)"+inItem.getDisplayName();
