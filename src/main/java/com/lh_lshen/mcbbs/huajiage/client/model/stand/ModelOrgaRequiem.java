...
public class ModelOrgaRequiem extends ModelStandBase {
	...
	public ModelOrgaRequiem() {
		...
		setRotationAngle(body, -0.0873F, -0.6981F, 0.0F);
		...
		setRotationAngle(leftArm, 0.0F, 0.3491F, 0.5236F);
		...
		setRotationAngle(lb_2, 0.0F, 0.0F, -1.309F);
		...
		setRotationAngle(rb_1, 0.0F, 0.1745F, 0.0F);
		rightArm.addChild(rb_1);
		rb_1.cubeList.add(new ModelBox(rb_1, 40, 16, -1.0F, -3.0F, -2.0F, 4, 6, 4, 0.0F, true));

		rb_2 = new ModelRenderer(this);
		rb_2.setRotationPoint(0.0F, 3.0F, 0.0F);
		setRotationAngle(rb_2, -0.1745F, -0.4363F, 0.0F);
		rightArm.addChild(rb_2);
		rb_2.cubeList.add(new ModelBox(rb_2, 48, 34, -1.0F, 0.0F, -2.0F, 4, 7, 4, 0.0F, true));

		leftLeg = new ModelRenderer(this);
		leftLeg.setRotationPoint(-2.9F, 11.0F, 0.0F);
		setRotationAngle(leftLeg, -0.6109F, -0.4363F, 0.0F);

		ll_1 = new ModelRenderer(this);
		ll_1.setRotationPoint(0.0F, 0.0F, 0.0F);
		setRotationAngle(ll_1, -0.6109F, 0.0F, 0.0F);
		leftLeg.addChild(ll_1);
		ll_1.cubeList.add(new ModelBox(ll_1, 0, 16, -2.0F, 0.0F, -2.0F, 4, 9, 4, 0.0F, false));

		ll_2 = new ModelRenderer(this);
		ll_2.setRotationPoint(0.0F, 6.5F, -2.0F);
		setRotationAngle(ll_2, 0.6981F, 0.0873F, 0.0F);
		leftLeg.addChild(ll_2);
		ll_2.cubeList.add(new ModelBox(ll_2, 48, 49, -2.0F, -2.0F, -3.0F, 4, 9, 4, 0.0F, false));

		rightLeg = new ModelRenderer(this);
		rightLeg.setRotationPoint(1.9F, 12.0F, 2.0F);
		setRotationAngle(rightLeg, 0.0873F, -1.1344F, 0.0F);

		rl_1 = new ModelRenderer(this);
		rl_1.setRotationPoint(0.0F, 0.0F, 0.0F);
		rightLeg.addChild(rl_1);
		rl_1.cubeList.add(new ModelBox(rl_1, 0, 16, -2.0F, 0.0F, -2.0F, 4, 6, 4, 0.0F, true));

		rl_2 = new ModelRenderer(this);
		rl_2.setRotationPoint(0.0F, 7.0F, 0.0F);
		setRotationAngle(rl_2, 0.0F, 0.1745F, 0.0F);
		rightLeg.addChild(rl_2);
		rl_2.cubeList.add(new ModelBox(rl_2, 48, 49, -2.0F, -2.0F, -2.0F, 4, 9, 4, 0.0F, true));

		Extra = new ModelRenderer(this);
		Extra.setRotationPoint(0.0F, 3.0F, 0.0F);
		setRotationAngle(Extra, 0.0F, 0.0F, -0.8727F);
	...
	public void render(Entity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw,
	    ...
	    head.offsetY = off;
	    leftArm.offsetY = (float) (off*0.8);
	    rightArm.offsetY = (float) (off*0.8);
	    body.offsetY = off;
	    leftLeg.offsetY = off;
	    rightLeg.offsetY = off;
	    hair_p_1.offsetY = (float) (MathHelper.sin((float) (0.05*ageInTicks))*0.25);
	    hair_p_2.offsetY = (float) (MathHelper.sin((float) (0.05*ageInTicks+1*Math.PI/3))*0.25);
	    hair_p_3.offsetY = (float) (MathHelper.sin((float) (0.05*ageInTicks+2*Math.PI/3))*0.25);
	    hair_p_4.offsetY = (float) (MathHelper.sin((float) (0.05*ageInTicks+3*Math.PI/3))*0.25);
	    hair_p_5.offsetY = (float) (MathHelper.sin((float) (0.05*ageInTicks+4*Math.PI/3))*0.25);
	    hair_p_6.offsetY = (float) (MathHelper.sin((float) (0.05*ageInTicks+5*Math.PI/3))*0.25);
	    hair_p_7.offsetY = (float) (MathHelper.sin((float) (0.05*ageInTicks+6*Math.PI/3))*0.25);
	    
	    Extra.rotateAngleY = ageInTicks/2;
