...
public class ContainerHuajiBlender extends Container {
	...
	public ContainerHuajiBlender(InventoryPlayer invPlayer, TileEntityHuajiBlender tileEntityHuajiBlader) {
