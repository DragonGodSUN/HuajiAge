...
if(isOpen(itemStack)) {	
 ...
 @Override
	...
	public void addInformation(final ItemStack stack, @Nullable final World world, final List<String> tooltip, final ITooltipFlag flag) {
		...
		{	
		tooltip.add(getTagCompoundSafe(stack).hasKey("active")?(""+TextFormatting.BOLD+I18n.format("item.blance_helmet:changeMode",KeyLoader.swich1.getKeyModifier()+"+"+Keyboard.getKeyName(KeyLoader.swich1.getKeyCode()))):(I18n.format("item.blance_helmet:unicode_tooltips.2.desc")));}
		else {
