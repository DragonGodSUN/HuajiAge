...
public class HuajiExplosion extends Explosion {
	...
	public HuajiExplosion(World worldIn, Entity entityIn, double x, double y, double z, float size, boolean flaming,
	            ...
	            for (int k = 0; k < 16; ++k)
	            {
	                for (int l = 0; l < 16; ++l)
	                {
	                	if (j == 0 || j == 15 || k == 0 || k == 15 || l == 0 || l == 15)
	                    {
	                        ...
	                        d1 = d1 / d3;
	                        d2 = d2 / d3;
	                        float f = this.size * (0.7F + this.world.rand.nextFloat() * 0.3F);
	                        double d4 = this.x;
	                        double d6 = this.y;
	                        double d8 = this.z;
