...
//  替身状态名称,若只有一个状态，可不写 -推荐格式：“stand.[替身ID].[替身状态]”
    stateKey:"stand.huajiage.prototype.idle",
//  模型ID
...
//  如：huajiage:star_platinum_idle,所有车万女仆模型id均为"[模型ID]_default"
    modelId:"huajiage:maid_01",//本模型载入游戏后的模型ID:huajiage:maid_01_idle（默认stateId均为default）
 ...
 */
    ...
    capability: function (worldWrapper,entityWrapper,dataWrapper) {
        ...
        Helper.playSound(entityWrapper.getLivingBase(), "huajiage:the_world", 5, 1);
